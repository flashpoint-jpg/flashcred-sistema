...
const { MercadoPagoConfig, Payment } = require('mercadopago'); // ✅ FORMA NOVA
...
// ✅ MERCADO PAGO NA VERSÃO CORRETA
...
app.post('/api/gerar-pix', async (req, res) => {
    try {
        ...
        const pag = await pagamentoServico.create({
            body: {
...
app.listen(PORTA, () => console.log('Servidor rodando perfeitamente!'));
